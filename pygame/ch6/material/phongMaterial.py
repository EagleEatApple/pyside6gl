...
class PhongMaterial(Material):
    ...
    def __init__(self, texture=None, bumpTexture=None,
                 properties={}, useShadow=False):
        ...
        void main()
        {
            ...
            if (useShadow) 
            {
                vec4 temp0 = shadow0.projectionMatrix * 
                             shadow0.viewMatrix *
        ...
        vec3 lightCalc(Light light, vec3 pointPosition, vec3 pointNormal)
        {
            ...
            if (light.lightType > 1) //directional ro point light
            {
